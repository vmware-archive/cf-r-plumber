...
An example API is hosted live on a Cloud Foundry environment [here](https://rplumber.apps.pcfone.io/echo).  To test the API is working try typing the following into a web browser:
```
